        ...
        inputBerat.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(editable: Editable) {
                ...
                if (editable != null && editable.isNotEmpty()) {
                    val beratString = editable.toString()
                    val berat = beratString.toDoubleOrNull() ?: 0.0

                    val hargaPerKg = 5000.0
                    val totalHarga = berat * hargaPerKg

                    // Tampilkan hasil dalam format rupiah
                    inputHarga.setText(rupiahFormat(totalHarga.toInt()))
                } else {
                    inputHarga.setText(rupiahFormat(0))
                }
            }
        })
